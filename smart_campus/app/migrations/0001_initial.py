    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True)),
                ('image', models.ImageField(blank=True, null=True, upload_to='images/travel_plan/')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='question',
            name='linked_station',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='app.Station'),
        ),
        migrations.AddField(
            model_name='choice',
            name='question',
